...
function add(breweryfile, isCask, formula) {
  var formula$1 = /* record */[/* name */formula];
  var match = 1 - isCask;
  return /* record */[
          /* cask */isCask !== 0 ? Pervasives.$at(breweryfile[/* cask */0], /* :: */[
                  formula$1,
                  /* [] */0
                ]) : breweryfile[/* cask */0],
          /* brew */match !== 0 ? Pervasives.$at(breweryfile[/* brew */1], /* :: */[
                  formula$1,
                  /* [] */0
                ]) : breweryfile[/* brew */1]
        ];
