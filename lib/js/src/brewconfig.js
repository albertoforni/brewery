...
function add(brewConfig, isCask, formula) {
  ...
  var match = 1 - isCask;
  return /* record */[
          /* cask */isCask !== 0 ? Pervasives.$at(brewConfig[/* cask */0], /* :: */[
                  $$package,
                  /* [] */0
                ]) : brewConfig[/* cask */0],
          /* brew */match !== 0 ? Pervasives.$at(brewConfig[/* brew */1], /* :: */[
                  $$package,
                  /* [] */0
                ]) : brewConfig[/* brew */1]
        ];
...
function remove(brewConfig, isCask, formula) {
  var filterFormula = List.filter((function (p) {
          return +(p[/* name */0] !== formula);
        }));
  var match = 1 - isCask;
  return /* record */[
          /* cask */isCask !== 0 ? Curry._1(filterFormula, brewConfig[/* cask */0]) : brewConfig[/* cask */0],
          /* brew */match !== 0 ? Curry._1(filterFormula, brewConfig[/* brew */1]) : brewConfig[/* brew */1]
        ];
}
