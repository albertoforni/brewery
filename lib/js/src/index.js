...
function loadBreweryConfig(readFile, _) {
  ...
  switch (command) {
    ...
    case 2 : 
        ...
        var res = Result.$great$great$eq(Result.$great$great$eq(Result.$great$great$eq(installBrewIfNeeded(system[/* exec */3]), (function (param) {
                        return loadBreweryConfig(partial_arg, param);
                      })), (function (param) {
    ...
    case 3 : 
        ...
        break;
    case 4 : 
        return Result.$great$great$eq(loadBreweryConfig(system[/* readFile */2], /* () */0), (function (breweryConfig) {
