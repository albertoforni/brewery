    ...
    switch (command) {
      ...
      case 2 : 
          return Result.$great$great$eq(installBrewIfNeeded(system[/* exec */3]), (function(args){
                    return function () {
                      return Result.$great$great$eq(loadBreweryConfig(system[/* readFile */2]), (function (breweryfile) {
                                    if (List.length(args)) {
                                      ...
                                      var res = Result.$great$great$eq(Result.$less$$great(installFormula(system[/* exec */3], args), (function (param) {
                                                  return addToBreweryfile(args, breweryfile, param);
                                                })), (function (param) {
                                      ...
                                      var isSuccess = List.for_all((function (res) {
                                              if (res.tag) {
                                                ...
                                                return /* true */1;
                                                      ...
                                                      var res = installFormula(system[/* exec */3], /* :: */[
                                                            f[/* name */0],
                                                            /* [] */0
                                                          ]);
                                                      if (res.tag) {
                                                    ...
                                                    }), breweryfile[/* brew */1]), List.map((function (f) {
                                                      var res = installFormula(system[/* exec */3], /* :: */[
                                                            "cask",
                                                            /* :: */[
                                                              f[/* name */0],
