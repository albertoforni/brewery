...
function getFormula(args) {
  return tryCatch((function () {
              ...
              }), /* Error */Block.__(1, ["No formula has been passed"]));
}

function installFormula(exec, args) {
  var installFormula$1 = function (param) {
    var isCask = param[1];
    var formula = param[0];
    return tryCatch((function () {
                  Curry._1(exec, "brew " + (
                  ...
                  return /* Ok */Block.__(0, [formula]);
                }), /* Error */Block.__(1, ["Error installing " + (String(formula) + " formula")]));
  };
  return Result.$great$great$eq(getFormula(args), installFormula$1);
}

function addToBreweryfile(args, breweryfile, formula) {
  var isCask = +(List.hd(args) === "cask");
  return Brewconfig.add(breweryfile, isCask, formula);
}

function uninstallFormula(exec, args, breweryfile) {
  var uninstallFormula$1 = function (param) {
    var isCask = param[1];
    var formula = param[0];
  ...
  return Result.$great$great$eq(getFormula(args), uninstallFormula$1);
}
...
function execCommand(system, _arguments) {
  while(true) {
    var $$arguments = _arguments;
    var match = getCommandAndArguments($$arguments);
    var args = match[1];
    switch (match[0]) {
      case 0 : 
      ...
      case 1 : 
          if (List.length(args)) {
            return /* Error */Block.__(1, ["I don't know the " + (List.hd($$arguments) + " command")]);
          } else {
            _arguments = /* :: */[
              "help",
              args
          ...
          break;
      case 2 : 
          var logInstallResult = function (res) {
            if (res.tag) {
              var err = res[0];
              Curry._1(system[/* log */0], err);
              return /* Error */Block.__(1, [err]);
            } else {
              Curry._1(system[/* log */0], res[0] + " installed successfully");
              return /* Ok */Block.__(0, [/* () */0]);
            }
          };
          return Result.$great$great$eq(Result.$great$great$eq(installBrewIfNeeded(system[/* exec */3]), (function () {
                            return loadBreweryConfig(system[/* readFile */2]);
                          })), (function(args){
                    return function (breweryfile) {
                      if (List.length(args)) {
                        var breweryfile$1 = breweryfile;
                        var partial_arg = system[/* writeFile */1];
                        var res = Result.$great$great$eq(Result.$less$$great(installFormula(system[/* exec */3], args), (function (param) {
                                    return addToBreweryfile(args, breweryfile$1, param);
                                  })), (function (param) {
                                return writeBrewFile(partial_arg, param);
                              }));
                        if (res.tag) {
                        ...
                        var breweryfile$2 = breweryfile;
                        var isSuccess = List.for_all((function (res) {
                                if (res.tag) {
                                  return /* false */0;
                                } else {
                                  return /* true */1;
                                }
                              }), Pervasives.$at(List.map((function (f) {
                                        return logInstallResult(installFormula(system[/* exec */3], /* :: */[
                                                        f[/* name */0],
                                                        /* [] */0
                                                      ]));
                                      }), breweryfile$2[/* brew */1]), List.map((function (f) {
                                        return logInstallResult(installFormula(system[/* exec */3], /* :: */[
                                                        "cask",
                                                        /* :: */[
                                                          f[/* name */0],
                                      ...
                                      }), breweryfile$2[/* cask */0])));
                        if (isSuccess !== 0) {
                          return /* Ok */Block.__(0, ["All formulas installed"]);
                        } else {
                          return /* Error */Block.__(1, ["Not all formulas installed"]);
                        }
                      }
                    }
                    }(args)));
      case 3 : 
          ...
          var res = Result.$great$great$eq(Result.$great$great$eq(installBrewIfNeeded(system[/* exec */3]), (function () {
                      return getInstalledFormulas(system[/* exec */3]);
      ...
      case 5 : 
          ...
          var res$1 = Result.$great$great$eq(Result.$great$great$eq(loadBreweryConfig(system[/* readFile */2]), (function(args,partial_arg){
...
function run(system, stdin) {
  var res = execCommand(system, parseArguments(stdin));
...
exports.addToBreweryfile       = addToBreweryfile;
